...
export const CHAPTER3_VISUAL_THEME: ChapterVisualTheme = {
  ...
  objectVisuals: {
    ...
    'chapter3-right-portrait': { offset: { x: 0, y: 24 }, depth: 0.12 },
    'chapter3-bottom-rug': {
      depth: 0.18,
      displaySize: { width: 128, height: 64 },
    },
    'chapter3-bottom-crates': { offset: { x: 24, y: -12 } },
    'chapter3-bottom-barrel': { offset: { x: 16, y: -8 } },
    'chapter3-bottom-left-plant': { offset: { x: 16, y: -16 } },
    'chapter3-bottom-right-plant': { offset: { x: -24, y: -40 } },
    'chapter3-memory-box': {
